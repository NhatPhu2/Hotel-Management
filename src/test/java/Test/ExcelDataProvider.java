...
public class ExcelDataProvider {
    ...
    public static Object[][] testData(String path, String sheetName, String testCaseName) {
        ...
        for (int i = row - 1; i < (rowCount != 1 ? (row - 1) + rowCount : row); i++) {
            for (int j = 1; j < colCount - 2; j++) {
                ...
                if (s == Cell.CELL_TYPE_STRING) {//kiểm tra kiểu dữ liệu
                ...
                } else if (s == Cell.CELL_TYPE_BOOLEAN) {
